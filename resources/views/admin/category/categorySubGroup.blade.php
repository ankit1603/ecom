			...
			<div class="page-content">
				...
				<div class="main-container">
					...
					<div class="page-header">
						...
						<ul class="app-actions">
							<li>
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg">Add Category Sub-Group</button>

						<form action="{{url('/admin/add-subCategory')}}" method="post">
							@csrf
									<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="myLargeModalLabel">Add Category Sub-Group</h5>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group">
										<label for="exampleFormControlTextarea1">Category Group</label>
										<select class="form-control form-control-lg" name="catgroupname" >
										...
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
											<div class="form-group">
												<label for="inputName">Category Sub-Group</label>
												<input type="text" name="catname" class="form-control" id="inputName" placeholder="Enter full name" required>
											</div>
										</div>
										...
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
											<div class="form-group">
												...
												<textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="2" required></textarea>
											</div>
										</div>
									...
									<div class="form-group">
										...
										<textarea class="form-control" name="metadescription" id="exampleFormControlTextarea1" rows="2" required></textarea>
									</div>
										...
										<tbody>
                                          ...
                                          if ($cat->active==0) echo "Inactive";
                                           ...
                                           ?></td>
											  ...
											  <a href="{{url('/admin/deletesubcategory/'.$cat->id)}}">
