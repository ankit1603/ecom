					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								...
								<div class="table-responsive">
									<table id="copy-print-csv" class="table custom-table">
										...
										<tbody>
											...
											<tr>
										<td><img src="{{asset('/upload/product/'.$product->image)}}" style="width:35px;"></td>
											  ...
											  <td>
											  	<a href="{{url('/admin/viewproducts/'.$product->id)}}" type="button" class="btn btn-info" title="View Product" data-toggle="modal" data-target=".bd-edit-modal-lg-view{{$product->id }}"><i class="fa fa-eye"></i></a>
											 
											  <a href="{{url('/admin/editproducts/{id}'.$product->id)}}" type="button" class="btn btn-primary" title="Update Product"  	
											  ...
											  <a href="{{url('/admin/deleteproducts/'.$product->id)}}">
							...
							<div class="card">
								...
								<!-- Edit Form Start -->
											<form action="{{ url('/admin/editproducts', ['id' => $product->id]) }}" method="post" enctype="multipart/form-data">{{csrf_field()}}
								...
								<div class="card-body">
									...
									<div class="row gutters">
										...
										<div class="col-xl-6 col-lglg-6 col-md-6 col-sm-6 col-6">
											<div class="form-group">
												<label for="inputEmail">GTIN</label>
												<input type="number" name="gtin" class="form-control" id="inputName" placeholder="Order"value="{{$product->gtin}}">
											</div>
										</div>
