			...
			<div class="page-content">
				...
				<div class="main-container">
					...
					<div class="page-header">
						...
						<ul class="app-actions">
							<li>
						<a href="{{url('admin/create')}}">Add Product</a>
					</li>
				</ul>
			</div>
								...
								<div class="table-responsive">
									<table id="copy-print-csv" class="table custom-table">
										...
										<tbody>
											...
											$Inventory=ProductsController::viewAttribute($inventorydetails->id);?>
											<tr>
												<td>{{$inventorydetails->stock_quantity}}</td>
											  ...
											  <td>{{$inventorydetails->product_id}}</td>
											  <td>{{$inventorydetails->available_from}}</td>
											  <td>{{$inventorydetails->purchase_price}}</td>
											  <td>{{$inventorydetails->sale_price}}</td>
											  <td>{{$inventorydetails->offer_price}}</td>
											  <td><?php	  $active=$inventorydetails->active; ?>
											  	<?php
											  if($active=='1')
											  	echo "Active";
											  else {
											  ...
											  <a href="{{url('/admin/deleteinventory/'.$inventorydetails->id)}}">
									...
									<div class="row gutters">
										...
										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
												...
												<input type="text" name="catname" class="form-control" id="inputName" placeholder="SKU" value="{{$inventorydetails->stock_quantity}}">
											</div>
										</div>
										...
										<div class="col-xl-6 col-lglg-6 col-md-6 col-sm-6 col-6">
											<div class="form-group">
												...
												<input type="number" name="gtin" class="form-control" id="inputName" placeholder="Stock"value="{{$inventorydetails->product_id}}">
											</div>
										</div>

										<div class="col-xl-6 col-lglg-6 col-md-6 col-sm-6 col-6">
											<label for="inputName">Date Created</label>
											<input type="text" name="category" class="form-control" id="inputName" placeholder="Product Price" value="{{$inventorydetails->available_from}}">
										</div>
										...
										<div class="col-xl-6 col-lglg-6 col-md-6 col-sm-6 col-6">
											<label for="inputName">Business Price</label>
											<input type="text" name="category" class="form-control" id="inputName" placeholder="Product Price" value="{{$inventorydetails->sale_price}}">
										</div>
										<div class="col-xl-6 col-lglg-6 col-md-6 col-sm-6 col-6">
											<label for="inputName">Lowest Price</label>
											<input type="text" name="category" class="form-control" id="inputName" placeholder="Product Price" value="{{$inventorydetails->offer_price}}">
										</div></div></div>
							</div>
						</div>
												</div>
