...
<head>
		...
		<link rel="shortcut icon" href="{{asset('upload/Logo/i shop logo-01.jpg')}}" />
				...
				<div class="row justify-content-md-center">
					<div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
						<div class="login-screen">
							<div class="login-box">
								<a href="http://127.0.0.1:8000" class="login-logo">
									<img src="{{asset('upload/Logo/logos.png')}}" alt="ISHOP" />
								</a>
								...
								<div class="forgot-pwd">
									<a class="link" href="{{url('/forgotPassword')}}">Forgot password?</a>
								</div>
								<hr>
								<div class="actions align-left">
									<span class="additional-link">New here?</span>
									<a href="{{url('/register')}}" class="btn btn-secondary">Create an Account</a>
								</div>
							</div>
						</div>
					</div>
