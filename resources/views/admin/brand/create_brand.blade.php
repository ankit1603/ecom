      ...
      <div class="page-content">
        ...
        <div class="main-container">
          ...
          <div class="page-header">
            ...
            <!-- Breadcrumb start -->
            <ol class="breadcrumb">
              <li class="breadcrumb-item">Our Brands </li>
            </ol>
            <!-- Breadcrumb end -->
                  ...
                  <div class="row gutters">
                    <div class="col-xl-6 col-lglg-6 col-md-6 col-sm-6 col-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="brandname" class="form-control" id="inputName" placeholder="Brand name" required>
                      </div>
                    </div>
                ...
                <div class="table-responsive">
                  <table id="copy-print-csv" class="table custom-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$i}}</td>
                        <td>{{$cat->name}}</td>
                        <td><img src="{{asset('/upload/Logo/'.$cat->image)}}" style="width:50px;"></td>
                        <td>
                        <?php if ($cat->active==1) echo "Active";
                                          if ($cat->active==0) echo "Inactive";
                                          
                                           ?></td>
                        <td><a href="{{url('/admin/editbrand/{id}'.$cat->id)}}" type="button" class="btn btn-primary" title="Update Brand"   
                        data-toggle="modal" data-target=".bd-edit-modal-lg-edit{{$cat->id }}"><i class="fa fa-edit"></i></a>


                        <a href="{{url('/admin/deletebrand/'.$cat->id)}}">
                        <button type="button" class="btn btn-danger" title="Delete Brand"onclick="return confirm('Are you sure you want to delete this?')" ><i class="fa fa-trash"></i></button></a></td>
                        
                        <!-- Edit Form Start -->
                      <form action="{{ url('/admin/editbrand', ['id' => $cat->id]) }}" method="post" enctype="multipart/form-data">{{csrf_field()}}
                  <div class="modal fade bd-edit-modal-lg-edit{{$cat->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="myLargeModalLabel">Edit Brands</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                  ...
                  <div class="row gutters">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="image" class="form-control" id="inputName" placeholder="Category name" value="{{$cat->image}}">
                      </div>
                    </div>
