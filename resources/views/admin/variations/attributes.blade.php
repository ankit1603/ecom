			...
			<div class="page-content">
				...
				<div class="main-container">
					...
					<div class="page-header">
						...
						<!-- Breadcrumb start -->
						<ol class="breadcrumb">
							<li class="breadcrumb-item">Add Attributes</li>
						</ol>
						<!-- Breadcrumb end -->
						...
						<ul class="breadcrumb">
							<li>
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg">Add Attributes</button>


						<form action="{{url('/admin/variationparameters')}}" method="post">{{csrf_field()}}
									<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="myLargeModalLabel">Add Attributes</h5>
									...
									<div class="row gutters">
										<div class="col-xl-6 col-lglg-4 col-md-4 col-sm-4 col-12">
											<div class="form-group">
												...
												<input type="text" name="catname" class="form-control" id="inputName" placeholder="Enter full name" style="height:37px;" required>
											</div>
										</div>
								...
								<div class="table-responsive">
									<table id="copy-print-csv" class="table custom-table">
										...
										<tbody>
                                          ...
                                          <tr>
                                          <td>{{$cats->name}}</td>
                                          <td><?php if ($cats->status==1) echo "Active";
                                          if ($cats->status==0) echo "Inactive";
                                          
                                           ?></td>
                                          
                                           <td><button type="button" class="btn btn-warning" data-toggle="modal" data-target=".bd-edit-modal-lg{{$cats->id }}">edit</button><a href="{{url('/admin/variationparameters/addunits/'.$cats->id)}}"type="button" class="btn btn-primary"><i class="fa fa-plus"></i></a>

                                           	<a href="{{url('/admin/variationparameters/'.$cats->id)}}"type="button" title="Delete Product"onclick="return confirm('Are you sure you want to delete this?')" class="btn btn-danger">Delete</a>
