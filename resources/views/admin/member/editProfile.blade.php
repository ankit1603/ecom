			...
			<div class="page-content">
				...
				<div class="main-container">
					...
					<div class="page-header">
						...
						<!-- Breadcrumb start -->
						<ol class="breadcrumb">
							<li class="breadcrumb-item">Member Registration</li>
						</ol>
						<!-- Breadcrumb end -->
					...
					<!-- Row start -->
					<form action="{{url('/admin/memberRegistration')}}" method="post" enctype="multipart/form-data">{{csrf_field()}}
...
<div class="form-group">
                                                            ...
                                                            <input type="text" name="m_name" required="" id="m_name" class="form-control" id="useremail" placeholder="Enter  Name">
                                                           
                                                        </div>
<div class="form-group">
                                                            <label for="m_name"> PAN No.</label>
                                                           
                                                            <input type="text" name="pan_no" required=""  class="form-control"  placeholder="Enter  Pan No." onblur="ValidatePAN()"id="m_pan">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" name="password" required="" id="password" class="form-control" id="username" placeholder="Enter Password">
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="sponsor_id">Sponsor ID</label>
                                                            <input type="text" class="form-control" name="sponsor_id" id="sponsor_id" onblur="getSponsor()" onkeyup="getSponsor()" required="" placeholder="Enter Sponsor ID">
                                                            <div><p id="sponsor_nameInvalid" style="color: red;"></p></div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="sponsor_name">Sponsor Name</label>
                                                            <input type="text" name="sponsor_name" id="sponsor_name" class="form-control" id="sponsor_name" readonly="" required="" placeholder="Sponsor Name">
                                                        </div>
                                                           <div class="form-group">
                                                            <input type="text" name="placement_id" id="placement_id" onblur="checkMemId()" value="" required="" class="form-control" placeholder="Placement ID*" >
