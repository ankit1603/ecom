...
@endif
 ...
 ?>
 <?php $randomsubs=membercontroller::talenthunt2detailsss(); $i=1;  ?>
   ...
   <tr>
											  <td>{{$i}}</td>
                                               ...
                                               <a href="{{url('/admin/approvetalenthunt2/'.$rndmsubs->id)}}" type="button" class="btn btn-primary" title="Approve"><i class="fa fa-check"></i></a>
											   <a href="{{url('/admin/rejecttalenthunt2/'.$rndmsubs->id)}}" type="button" class="btn btn-primary" title="Reject"><i class="fa fa-close"></i></a><?php
