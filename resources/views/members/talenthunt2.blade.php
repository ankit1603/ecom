...
@endif				<!-- Breadcrumb start -->
						<ol class="breadcrumb">
							<li class="breadcrumb-item">Talent Hunt 2 List</li>
						</ol>
						<!-- Breadcrumb end -->
						...
						<ul class="app-actions">
							<li>
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg">Take participate</button>

			<form action="{{url('member/TalentHunt2')}}" method="post" enctype="multipart/form-data">{{csrf_field()}}
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									...
									<div class="form-group">
												...
												<input type="text" name="videolink" class="form-control" id="inputName" placeholder="Video Link" required="">
									</div>
									<div class="form-group">
												<label for="inputName">Amount</label>
												<input type="text" name="amount" class="form-control" id="amount" value="500" placeholder="Video Link" readonly>
									</div>
									...
									<div class="form-group">
												<label for="inputName">Wallet</label>
												<input type="text" name="onlinepayment" class="form-control" id="onlinepayment" placeholder="Online Payment"readonly required>
									</div>
 ...
 ?>
 <?php $randomsubs=membercontroller::talenthunt2details(); $i=1;  ?>
...
@endforeach
    ...
    function checkewallet() {
    	...
    	if (ewallet>400) {
    		data="E-wallet Amount should not be greater than 400"
