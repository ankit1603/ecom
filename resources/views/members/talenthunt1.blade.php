...
@endif
			...
			<form action="{{url('member/TalentHunt1')}}" method="post" enctype="multipart/form-data">{{csrf_field()}}
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									...
									<div class="form-group">
												...
												<input type="text" name="ewallet" value="0" class="form-control" id="ewallet" placeholder="E-wallet" onkeyup="checkewallet()"onblur="checkewallet()">
												<div id="errorOfPlacementId" style="color: red"></div>
									</div>

									<div class="form-group">
												<label for="inputName">Wallet</label>
												<input type="text" name="onlinepayment" class="form-control" id="onlinepayment" placeholder="Wallet"readonly>
									</div>
 ...
 ?>
 <?php $randomsubs=membercontroller::talenthunt1details(); $i=1;  ?>
