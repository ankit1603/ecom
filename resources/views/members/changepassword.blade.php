		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<div class="main-container">
					...
					<form action="{{url('/member/ChangePassword')}}" method="post" enctype="multipart/form-data">{{csrf_field()}}
...
<div class="form-group">
                                                            <label for="m_name"> Old Password </label>
                                                            <input type="text" name="oldpassword" required="" id="m_name" class="form-control" id="useremail" placeholder="Enter Old Password" >
                                                           
                                                        </div>
<div class="form-group">
                                                            <label for="m_name">New Password</label>
                                                           
                                                            <input type="text" name="newpassword" required=""  class="form-control"  placeholder="Enter  New Password" id="m_pan">
                                                             <div class="text-danger" id="panerror"></div>
                                                           
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="m_email">Re-Enter New Password</label>
                                                            <input type="text" name="confrmpassword" id="m_email" class="form-control" id="useremail"  placeholder="Re-Enter New Password">
                                                        </div>
