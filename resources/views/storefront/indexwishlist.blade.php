                    ...
                    <div class="theme-card">
                          <div class="row">
                            <table id="MyTable1" class="table table-responsive-md table-striped">
                                                        ...
                                                        <?php $i=1;  ?>
                                                           @foreach($wishlistvar as $custodrs)
                                             ...
                                             <?php $randomsub=indexcontroller::productdetails($custodrs->product_id);   ?>
                                                           ...
                                                           <tr>
                                                            <td>{{$i}}</td>
                                                            <td><img src="../upload/product/{{$rndmsub->image}}" alt="" class="img-fluid " style="width: 50px;"></td>
                                                              <td>{{$rndmsub->name}}</td>
                                                              <td><i class="fa fa-rupee"></i>{{round($rndmsub->max_price)}}</td>
                                                          
                                                          
                                                            <td>{{$custodrs->created_at}}</td> 
                                                            <td><a href="{{url('wishlistdelete/'.$custodrs->id)}}"type="button" class=" D btn btn-danger"><i class="fa fa-trash" title="Delete"></i></a></td> 
                                                           </tr>
                                                           <?php $i++;   ?>
                                                            @endforeach 
                                                             @endforeach 
