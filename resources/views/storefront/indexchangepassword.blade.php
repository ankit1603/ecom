        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="dashboard-right">
                    ...
                    <form class="theme-form"action="{{url('changepasswords')}}" method="post">{{csrf_field()}}
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="password" class="form-control"name="confrmpassword" placeholder="Confirm New Password" required="">
                        </div><button type="submit" class="btn btn-solid">Change Password</button></form>
                </div>
                    </div>
                </div>
            </div>
