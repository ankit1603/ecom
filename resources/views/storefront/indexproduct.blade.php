...
<?php  use \App\Http\Controllers\indexcontroller; 
 ...
 ?>
 <?php $randomsub=indexcontroller::productdetails($id);   ?>
                ...
                <div class="col-sm-3 collection-filter">
                    ...
                    <div class="collection-filter-block">
                        <div class="product-service">
                            <a href="{{url('pages/6')}}"><div class="media">
                            ...
                            <a href="{{url('pages/6')}}">  <div class="media">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"  x="0px" y="0px" viewBox="0 0 480 480" style="enable-background:new 0 0 480 480;" xml:space="preserve" width="512px" height="512px">
                                        <g>
                                            <g>
                                                <g>
                            ...
                            <a href="{{url('pages/6')}}"> <div class="media border-0 m-0">
                    ...
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <?php $categ=$rndmsub->categoryid;  $randomsubs=indexcontroller::randomproducttt($categ);   ?>
                                          @foreach($randomsubs as $rndomprod)
                                 <div class="media">
                                    <a href="{{url('/product/'.$rndomprod->id)}}"><img class="img-fluid " src="../upload/product/{{$rndomprod->image}}" alt="" style="width: 100px;"></a>
                                    <div class="media-body align-self-center">
                                        <a href="product-page(no-sidebar).html"><h6>{{$rndomprod->name}}</h6></a>
                                        <h4><i class="fa fa-rupee"></i> {{round($rndomprod->max_price)}}</h4>
                                    </div>
                                </div>
                                ...
                                <div>
                                <?php  $randomsub=indexcontroller::randomproducttt($categ);   ?>
                                          @foreach($randomsubs as $rndomprod)
                                 <div class="media">
                                    <a href=""><img class="img-fluid " src="../upload/product/{{$rndomprod->image}}" alt="" style="width: 100px;"></a>
                                    <div class="media-body align-self-center">
                                        <a href="product-page(no-sidebar).html"><h6>{{$rndomprod->name}}</h6></a>
                                        <h4><i class="fa fa-rupee"></i> {{round($rndomprod->max_price)}}</h4>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="product-slick">
                                    <div><img src="../upload/product/{{$rndmsub->image}}" alt="" class="img-fluid  image_zoom_cls-0"></div>
                                    <div><img src="../upload/product/{{$rndmsub->image}}" alt="" class="img-fluid  image_zoom_cls-1"></div>
                                    <div><img src="../upload/product/{{$rndmsub->image}}" alt="" class="img-fluid  image_zoom_cls-2"></div>
                                    <div><img src="../upload/product/{{$rndmsub->image}}" alt="" class="img-fluid  image_zoom_cls-3"></div>
                                </div>
                                <div class="row">
                                    <div class="col-12 p-0">
                                        <div class="slider-nav">
                                            <div><img src="../upload/product/{{$rndmsub->image}}" alt="" class="img-fluid "></div>
                                            <div><img src="../upload/product/{{$rndmsub->image}}" alt="" class="img-fluid "></div>
                                            <div><img src="../upload/product/{{$rndmsub->image}}" alt="" class="img-fluid "></div>
                                            <div><img src="../upload/product/{{$rndmsub->image}}" alt="" class="img-fluid "></div>
                                        </div>
                            ...
                            <div class="col-lg-6 rtl-text">
                                <div class="product-right">
                                    <h2>{{$rndmsub->name}}</h2>
                                    <h4><del><i class="fa fa-rupee"></i>{{round($rndmsub->max_price)}}</del><span>55% off</span></h4>
                                    <h3><i class="fa fa-rupee"></i>{{round($rndmsub->min_price)}}</h3>
                                    ...
                                    <div class="product-description border-product">
                                          @foreach($variationacccat as $varitionacat)
                                          <?php $variationdetail=indexcontroller::viewvariationdetail($varitionacat->variationsid); ?>@foreach($variationdetail as $vartiondtail)
                                          
                                        <h6 class="product-title size-text">select {{$vartiondtail->name}} <span><a href="" data-toggle="modal" data-target="#sizemodal">{{$vartiondtail->name}} chart</a></span></h6>
                                        ...
                                        <div class="size-box">
                                            <ul>   @foreach($InventoryProd as $InvntryProd)

                                                <li><a href="javascript:void(0)">s</a></li>@endforeach  
                                    ...
                                    <div class="product-buttons">  <?php  if($user = Auth::user())
{   ?><a href="{{url('/session/sets/'.$id)}}" type="button" class=" cartD btn btn-solid">add to cart</a>  <?php  } else { ?><a href="{{url('/session/set/'.$id)}}" type="button"   data-target="" tabindex="0" class="cartD btn btn-solid ">add to cart</a> <?php }  ?><a href="{{url('/myAccount')}}" class="btn btn-solid">buy now</a>  </div>
...
{   ?><a href="{{url('/session/storewish/'.$id)}}" type="button" class="wishlist-btn d-inline-block"><i class="fa fa-heart"></i><span class=" A title-font">Add To WishList</span></a>  <?php  } else { ?><!--<a href="{{url('/session/set/'.$id)}}" type="button" class="btn btn-solid">add to cart</a>---> <?php }  ?>
                                ...
                                <div class="tab-content nav-material" id="top-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="top-contact" role="tabpanel" aria-labelledby="contact-top-tab">
                                        <div class="mt-3 text-center">
                                            <iframe width="560" height="315" src="{{$rndmsub->videolink}}" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                        </div>
                                    </div>
...
<section class="section-b-space ratio_square product-related">
    <div class="container">
        ...
        <div class="slide-6">
            <?php $categ=$rndmsub->categoryid;  $randomsubs=indexcontroller::randomproductttt($categ);   ?>
                                          @foreach($randomsubs as $rndomprod)
            <div class="">
