...
<section class="breadcrumb-section section-b-space">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="page-title"> @foreach($pages as $pagesn)
                    <h2>{{$pagesn->pagename}}</h2> @endforeach
                </div>
            </div>
            <div class="col-12">
                <nav aria-label="breadcrumb" class="theme-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <?php  $about=$pagesn->content;?>
                        <li class="breadcrumb-item active" aria-current="page">{{$pagesn->pagename}}</li>
                        @endforeach
                    </ol>
                </nav>
            </div>
