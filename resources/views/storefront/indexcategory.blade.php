...
<?php  use \App\Http\Controllers\indexcontroller; 
 ...
 ?>
 <?php $randomsub=indexcontroller::categorydetails($id);   ?>
            ...
            <div class="col-12">
                <nav aria-label="breadcrumb" class="theme-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{$rndmsub->name}}</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="col-sm-3 collection-filter">
                        ...
                        <div class="collection-collapse-block open">
                            ...
                            <div class="collection-collapse-block-content">
                                <div class="collection-brand-filter">
                                    @foreach($brandbycat as $brcatss)
                                       
                             <?php $randomsubss=indexcontroller::viewbranddetail($brcatss->brand);   ?>  
                                  @foreach($randomsubss as $raubss)  
                                <div class="custom-control custom-checkbox collection-filter-checkbox">
                                        <input type="checkbox" onclick="filterbybrand(this.id)" name="cat[]"value="{{$raubss->id}}" class="custom-control-input"  id="{{$raubss->id}}">
                                        <label class="custom-control-label" for="{{$raubss->id}}">{{$raubss->name}}</label>
                         ...
                         <div class="collection-collapse-block open">
                           ...
                           {{$vartiondtail->name}} </h3>
                            <div class="collection-collapse-block-content">
                                <div class="collection-brand-filter">
                                   <?php $variationvaluedetail=indexcontroller::variationvaluedetail($vartiondtail->id); 
                                   ?>@foreach($variationvaluedetail as $vartionvaldtail)
                                <div class="custom-control custom-checkbox collection-filter-checkbox">
                                        <input type="checkbox" onclick="filterbybrand(this.id)" name="cat[]"value="{{$vartionvaldtail->id}}" class="custom-control-input"  id="{{$vartionvaldtail->id}}">
                                        <label class="custom-control-label" for="{{$vartionvaldtail->id}}">{{$vartionvaldtail->values}}  <?php $variationunitdetail=indexcontroller::variationunitdetail($vartionvaldtail->unitid); ?>@foreach($variationunitdetail as $vartionuntdtail)
                                            {{$vartionuntdtail->name}}  @endforeach</label>
                                    </div>
                                   @endforeach
                    ...
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <?php  $randomsub=indexcontroller::randomproducttt($id);   ?>
                                          @foreach($randomsub as $rndomprod)
                                 <div class="media">
                                    <a href="{{url('/product/'.$rndomprod->id)}}"><img class="img-fluid " src="../upload/product/{{$rndomprod->image}}" alt="" style="width: 100px;"></a>
                                    <div class="media-body align-self-center">
                                        <a href="{{url('/product/'.$rndomprod->id)}}"><h6>{{$rndomprod->name}}</h6></a>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                  <div class="top-banner-wrapper">
                                    <a href="#"><img src="{{asset('font_assets/images/about/about-us.jpg')}}" class="img-fluid " alt=""></a>
                                ...
                                <div class="collection-product-wrapper">
                                            ...
                                            <div class="col-12">
                                                <div class="product-filter-content">
                                                    ...
                                                    <div class="product-page-per-view">
                                                        <select id="noofproducts" onchange="productaccording(this.value);" >
                                                            <option value="24">16 Products Par Page</option>
                                                            <option value="32">32 Products Par Page</option>
                                   ...
                                   <!--  <div class="product-wrapper-grid">
                                        <div class="row container" id="table_data"> -->

                                       <!--     @include('storefront.paginationdata')
                    ...
                    <div class="instagram">
                        <div>
                            <div class="instagram-banner">
                                <h5>follow us <span>#Big Boost</span></h5>
                            </div>
                            <div class="container">
                                <div class="row">
                                    <div class="col p-0">
...
<!-- <script type="text/javascript">
 ...
 function fetch_data(page)
 {
  ...
  $.ajax({
   ...
   url:"{{url('pagination/fetch_data')}}/"+page,
...
<script type="text/javascript">
   ...
   url:"{{url('pagination/checkfilter')}}/"+elid,
   type:post,
   data:{cats:cat}
