            ...
            <div class="col-lg-9">
                <div class="dashboard-right">
                    ...
                    <div class="theme-card">
                          <div class="row">
                            <table id="MyTable1" class="table table-responsive-md table-striped">
                                                        <tr>
                                                            <th>S.N.</th>
                                                            <th>Order No.</th>
                                                            <th>Total</th>
                                                        ...
                                                        <?php $i=1;  ?>
                                                           @foreach($customerorders as $custodrs)

                                                           <tr>
                                                            <td>{{$i}}</td>
                                                            <td>{{$custodrs->id}}</td>
                                                              <td><i class="fa fa-rupee"></i>{{$custodrs->TotalAmount}}</td>
                                                            <td><?php  if($custodrs->order_status==1)echo "Pending";  if($custodrs->order_status==2)echo "Approved"; if($custodrs->order_status==3)echo "Delivered";if($custodrs->order_status==4)echo "Cancelled";   ?></td>
                                                          
                                                            <td>{{$custodrs->created_at}}</td> 
                                                            <td><a href="{{url('myorders/'.$custodrs->id)}}"type="button" class="btn btn-info"><i class="fa fa-eye" title="View"></i></a></td> 
                                                           </tr>
                                                           <?php $i++;   ?>
                                                            @endforeach 
                                                    </table>
