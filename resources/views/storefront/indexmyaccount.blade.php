                                ...
                                <div class="col-sm-6">
                                    <div class="box">
                                        ...
                                        <div class="box-content">
                                            ...
                                            <h6><a href="{{url('/ChangePassword')}}">Change Password</a></h6></div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="box">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 right-login">
                ...
                <div class="theme-card authentication-right">
                    ...
                    <p>Sign up for a free account at our store. Registration is quick and easy. It allows you to be able to order from our shop. To start shopping click register.</p><a href="{{url('/register')}}" class="btn btn-solid">Create an Account</a>
                    <h5 class="forget-class"><a href="{{url('/login')}}" class="d-block" style="
    margin-top: 20px;
">Sign Up With Facebook?</a></h5></div>
