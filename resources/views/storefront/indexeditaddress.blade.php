            ...
            <div class="col-lg-9">
                <div class="dashboard-right">
                    ...
                    <div class="theme-card">
                          <div class="row">                
                                                 <?php $randomsub=indexcontroller::addressdetails($id);   ?>
                                                  @foreach($randomsub as $rndmsub)
                                                <form class="theme-form"action="{{url('editaddress')}}" method="post">{{csrf_field()}}

                                                <div class="form-group required-field">
                                                    <label>Name </label>
                                                    <input type="text" name="name" value="{{$rndmsub->name}}"  class="form-control">
                                                ...
                                                <div class="form-group required-field">
                                                    ...
                                                    <div class="form-control-tooltip">
                                                        <input type="tel" name="mobile" value="{{$rndmsub->phone}}" class="form-control" >
                                                    </div><!-- End .form-control-tooltip -->
                                                </div><!-- End .form-group -->

                                                <div class="form-group required-field">
                                                    <label>Email </label>
                                                    <input type="email" name="email"value="{{$rndmsub->email}}"  class="form-control">
                                                </div><!-- End .form-group -->

                                                <div class="form-group required-field">
                                                    <label>Street Address (House No. Building Name) </label>
                                                    <input type="text" name="address"value="{{$rndmsub->address_line_1}}" class="form-control" >
                                                </div><!-- End .form-group -->

                                                <div class="form-group required-field">
                                                    <label>Road Area Colony  </label>
                                                    <input type="text" name="area" value="{{$rndmsub->address_line_1}}" class="form-control" >
                                                </div><!-- End .form-group -->

                                                <div class="form-group">
                                                    <label>Landmark </label>
                                                    <input type="text" name="landmark"value="{{$rndmsub->address_line_1}}"  class="form-control" >
                                                </div><!-- End .form-group -->
