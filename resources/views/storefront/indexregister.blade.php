        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="theme-card">
                    <form class="theme-form" action="{{url('/registration')}}" method="post">{{csrf_field()}}
                        <div class="form-row">
                            <div class="col-md-6">
                        ...
                        <div class="form-row">
                              <div class="col-md-6">
                                ...
                                <input type="text " maxlength="10" class="form-control" name="mobile" placeholder="Mobile Number" required=" ">
                            </div>
                            ...
                            <div class="col-md-6">
                                <input type="submit" value="create Account" class=" d btn-solid btn register">
                                                      <!--  <a href="{{url('/myAccount')}}" type="button" class="btn btn-solid"solid" style="
    margin-bottom: 30px;">Login</a> -->
                            </div>
